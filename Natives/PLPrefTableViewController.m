...
- (UITableViewCell *)tableView:(nonnull UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (item[@"type"] == self.typeChildPane || item[@"type"] == self.typePickField || item[@"type"] == self.typeLabel) {
        cellID = @"cellValue1";
...
- (void)initViewCreation {
    ...
    self.typeLabel = ^void(UITableViewCell *cell, NSString *section, NSString *key, NSDictionary *item) {
        cell.selectionStyle = UITableViewCellSelectionStyleNone;
