...
If you want to build this repository yourself, read [BUILD.md](BUILD.md) first.

- Linux users should start with the GitHub-hosted workflow in `.github/workflows/github-hosted-build.yml`.
- The older workflow files in `.github/workflows/` use private self-hosted runners and are not plug-and-play in a fresh repository.
