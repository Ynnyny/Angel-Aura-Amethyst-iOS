...
payload: native dep_mg java jre assets
	...
	plutil -replace CFBundleShortVersionString -string $(VERSION) $(SOURCEDIR)/Natives/Info.plist
	plutil -replace CFBundleVersion -string $(VERSION) $(SOURCEDIR)/Natives/Info.plist
